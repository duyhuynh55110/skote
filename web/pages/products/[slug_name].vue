          ...
          <div class="row">
            ...
            <div class="col-xl-6">
              <div class="mt-4 mt-xl-3">
                <a href="#" class="text-primary me-1">#Headphone</a>
                <a href="#" class="text-primary me-1">#Electronic</a>
                ...
                <div class="row mb-3">
                  <div class="col-md-6">
                    <div>
                      ...
                      <p class="text-muted">
                        <i
                          class="bx bx-shape-triangle font-size-16 align-middle text-primary me-1"
                        ></i>
                        Wireless Range : 10m
                      </p>
                      <p class="text-muted">
                        <i
                          class="bx bx-battery font-size-16 align-middle text-primary me-1"
                        ></i>
                        Battery life : 6hrs
                      </p>
                    </div>
          ...
          <div class="mt-5">
            ...
            <div class="media border-bottom">
              ...
              <div class="media-body">
                ...
                <ul class="list-inline float-sm-right mb-2">
                  <li class="list-inline-item">
                    <a href="#"><i class="far fa-thumbs-up me-1"></i> Like</a>
                  </li>
                  <li class="list-inline-item">
                    <a href="#"
                      ><i class="far fa-comment-dots me-1"></i> Comment</a
                    >
                  </li>
                </ul>
            ...
            <div class="media mt-3 border-bottom">
              ...
              <div class="media-body">
                ...
                <div class="text-muted font-size-12">
                  <i class="far fa-calendar-alt text-primary me-1"></i> 07 Oct,
                  2019
                </div>
                <div class="media mt-4">
                  ...
                  <div class="media-body">
                    ...
                    <ul class="list-inline float-sm-right mb-2">
                      <li class="list-inline-item">
                        <a href="#"
                          ><i class="far fa-thumbs-up me-1"></i> Like</a
                        >
                      </li>
                      <li class="list-inline-item">
                        <a href="#"
            ...
            <div class="media mt-3 border-bottom">
              ...
              <div class="media-body">
                ...
                <div class="text-muted font-size-12">
                  <i class="far fa-calendar-alt text-primary me-1"></i> 05 Oct,
                  2019
                </div>
              </div>
            </div>
                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col-md-8">
                      <div class="text-center text-md-left pt-3 pt-md-0">
                        ...
                        <h5 class="my-0">
                          <span class="text-muted me-2"><del>$240</del></span>
                          <b>$225</b>
                        </h5>
                      </div>
                    </div>
                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col-md-8">
                      <div class="text-center text-md-left pt-3 pt-md-0">
                        ...
                        <h5 class="my-0">
                          <span class="text-muted me-2"><del>$150</del></span>
                          <b>$145</b>
                        </h5>
                      </div>
                    </div>
                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col-md-8">
                      <div class="text-center text-md-left pt-3 pt-md-0">
                        ...
                        <h5 class="my-0">
                          <span class="text-muted me-2"><del>$138</del></span>
                          <b>$135</b>
                        </h5>
                      </div>
                    </div>
