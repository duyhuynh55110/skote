      ...
      <div class="container-fluid">
        <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
          <div class="collapse navbar-collapse" id="topnav-menu-content">
            <ul class="navbar-nav">
              <li v-for="(link, i) in navbarLinks" :key="i" class="nav-item">
                <NuxtLink :to="link.url" class="nav-link text-capitalize" active-class="active">
...
const currentUser: ComputedRef<User | null> = computed(
  (): User | null => authStore.currentUser
);
